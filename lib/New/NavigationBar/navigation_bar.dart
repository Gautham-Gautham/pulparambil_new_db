...
import 'package:pulparambil/New/LivePage/Screens/live_page_initialising.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        //       ),
        //     ],
        //     color: const Color(0xFFA3324A),
        //     buttonBackgroundColor: const Color(0xFFA3324A),
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          key: _bottomNavigationKey,
          backgroundColor: const Color(0xFFA3324A),
